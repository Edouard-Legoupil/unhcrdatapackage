...
data <- dplyr::left_join( x= unhcrdatapackage::end_year_population_totals_long, 
  ...
  mutate( DisplacedAcrossBordersRound =  scales::label_number_si(accuracy = 0.1)(DisplacedAcrossBorders)) %>%
...
#Make plot
ggplot(data, 
       aes(x = reorder(CountryOriginName, DisplacedAcrossBorders), ## Reordering country by Value
  ...
  ## Adding labels
  geom_label(aes(x = CountryOriginName, y = DisplacedAcrossBorders, 
  ...
  labs(title = paste0("What are the main Origin of Forced Displacement across Borders?","" ),
       subtitle = paste0("Top 10 Origin - Data as of ",lastyear), 
       x = " ",
       y = "# of Forcibly Displaced People",
       caption = "Data: UNHCR Refugee Population Statistics Database; Visualisation: UnhcrDataPackage.\n Forced Displacement includes Refugees, Asylym Seekers and Venezuelan Displaced Abroad") +
...
ggplot(Source, aes(x = reorder(CountryAsylumName, DisplacedAcrossBorders), ## Reordering country by Value
  ...
  geom_bar(stat = "identity", 
           position = "stack",
           fill = unhcRstyle::unhcr_blue) + 
  
  geom_label(aes(x = CountryAsylumName, y = DisplacedAcrossBorders, 
  ...
  ## and the chart labels
  labs(title = paste0("What are the main Countries of Asylum of Forced Displaced People across Border?"),
       subtitle = paste0("Top 10 Countries - Data as of ",lastyear), 
       x = "",
       y = "",
       caption = "Data: UNHCR Refugee Population Statistics Database; Visualisation: UnhcrDataPackage.\n Forced Displacement includes Refugees, Asylym Seekers and Venezuelan Displaced Abroad") +   
  ## Styling
...
ggplot(Solution, aes(x = Year, y = Value2  )) + 
  ...
  labs(title = "What are the trends in terms of Solutions?",
       subtitle = paste0("Data for Forcibly Displaced People across Borders as of ",lastyear ), 
       x = "",
       y = "",
       caption = "Data: UNHCR Refugee Population Statistics Database; Visualisation: UnhcrDataPackage.\n Forced Displacement includes Refugees, Asylym Seekers and Venezuelan Displaced Abroad Population Groups.")
