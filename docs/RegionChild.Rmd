...
networkD3::saveNetwork(p, paste0(getwd(),"/decision", thisbureau ,".html"))

# you convert it as png -- Need first webshot::install_phantomjs()
webshot::webshot(paste0(getwd(),"/decision", thisbureau ,".html"),
                 paste0(getwd(),"/decision", thisbureau ,".png"),
