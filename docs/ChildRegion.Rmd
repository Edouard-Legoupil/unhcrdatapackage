...
#Make plot
ggplot(data, aes(x = reorder(CountryOriginName, DisplacedAcrossBorders), ## Reordering country by Value
  ...
  ## and the chart labels
  labs(title = paste0("What are the main Origin of Forced Displacement across Borders in ",thisbureau , "?" ),
...
ggplot(Source, aes(x = reorder(CountryAsylumName, Value2), ## Reordering country by Value
  ...
  labs(title = paste0("What are the main Countries of Asylum of Forced Displaced People across Border?"),
       subtitle = paste0("Data as of ",lastyear, " filtered for ", thisbureau), 
       x = "",
       y = "",
       caption = "Data: UNHCR Refugee Population Statistics Database; Visualisation: UnhcrDataPackage.\n Forced Displacement includes Refugees, Asylym Seekers and Venezuelan Displaced Abroad Population Groups.") +
