...
## For info, this doc has 3 subchild depending on the level of disaggregation
...
>  addressed through predefined crafted <span style="color: #0072BC;">__static charts__</span>
  ...
  1. What is the share of Forcibly Displaced People among total __Migrants__? 

  2. How the different __Categories__ of Forcibly Displaced People are evolving over time? 
 
  3. What are the main Countries of __Origin__ of Forcibly Displaced People? 
  ...
  6. Is the asylum __Processing__ capacity in relation with the demand? 
...
#### Central Asia{.tabset .tabset-pills}
