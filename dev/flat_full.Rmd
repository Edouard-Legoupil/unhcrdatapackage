...
test_that("plot_ctr_processing_time works", {
  expect_true(inherits(plot_ctr_processing_time, "function")) 
})
```
...
test_that("plot_reg_treemap works", {
  expect_true(inherits(plot_reg_treemap, "function")) 
})
```
...
test_that("plot_reg_origin_dest works", {
  expect_true(inherits(plot_reg_origin_dest, "function")) 
})
```
...
plot_reg_population_type_abs <- function(year = 2022,
  ...
  df <- end_year_population_totals_long |>
      ...
      dplyr::arrange(Year) |>
      dplyr::mutate(diff_pop_type_value = scales::percent(((Value - lag(Value))/lag(Value)),
                                                          accuracy = 1.1,
                                                          trim = FALSE  )) |> 
      dplyr::ungroup() |>
      dplyr::filter(Year == year) |> 
...
test_that("plot_reg_prop_origin works", {
  expect_true(inherits(plot_reg_prop_origin, "function")) 
})
```
...
test_that("plot_reg_solution works", {
  expect_true(inherits(plot_reg_solution, "function")) 
})
```
